  ...
  render() {
    return (
      ...
      <div> 
        ...
        <NavBar/>
        <Switch>
          <Route exact path="/"><News apiKey={this.apiKey} keys='general' pageSize={this.pageSize} country="in" category="general"/></Route>
          ...
          <Route exact path="/general"><News apiKey={this.apiKey} key="general2" pageSize={this.pageSize} country="in" category="general"/></Route>
